...
open class AwesomeTextField: UITextField {
    ...
    func drawLine() {
        if let image = leftImage {
            ...
            self.imageView.alpha = placeholderAlphaBefore
    ...
    override open func drawPlaceholder(in rect: CGRect) {
        ...
        placeholderLabel = UILabel(frame: CGRect(x: rect.origin.x+leftPadding, y: underLineWidth, width: rect.size.width, height: font!.pointSize))
    ...
    func drawPlaceholderIfTextExistInRect(rect: CGRect) {
        placeholderLabel = UILabel(frame: CGRect(x: rect.origin.x+leftPadding, y: underLineWidth, width: rect.size.width, height: self.font!.pointSize))
    ...
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        ...
        self.textAlignment = .left
        self.contentVerticalAlignment = .bottom
        return bounds.insetBy(dx: self.textInsetX+leftPadding, dy: insetForY)
    }
        ...
        if !self.isLifted {
            UIView.animate(withDuration: animationDuration, animations: {
                ...
                if  self.leftImage != nil{
                    self.imageView.alpha = self.underLineAlphaAfter
                }
    ...
    func didEndChangeText() {
        if self.isLifted && self.text!.isEmpty {
            UIView.animate(withDuration: animationDuration, animations: {
                ...
                if self.leftImage != nil{
                    self.imageView.alpha = self.underLineAlphaBefore
                }
